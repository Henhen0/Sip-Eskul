        ...
        <div class="left-side" id="leftPanel">
            <div class="logo-section">
                ...
                <div class="welcome-text">
                    ...
                    <p>Masuk ke akun Anda untuk melanjutkan pendaftaran dan memulai belajar dengan fitur yang tersedia</p>
                </div>
            </div>
        </div>
        ...
        <div class="right-side">
            <div class="form-wrapper">
                <div class="form-header text-center">
                    <h3><i class="fas fa-user-graduate me-2"></i>Login Siswa</h3>
                    <p>Silakan masukkan data login Anda</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex justify-content-center gap-2 mt-2">
                        ...
                        <a href="{{ url('/') }}" class="btn btn-outline-warning btn-sm">
                            <i class="fas fa-home me-1"></i> Kembali Halaman Utama
                        </a>
                    </div>
                </form>
            </div>
